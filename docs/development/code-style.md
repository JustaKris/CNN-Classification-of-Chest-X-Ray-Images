...
def preprocess_image(image_file: str, target_size: tuple[int, int] = (224, 224)) -> Any:
...
- **Classes**: PascalCase (`CustomException`, `CustomTensorBoardCallback`)
- **Functions**: snake_case (`preprocess_image`, `load_model`)
- **Constants**: UPPER_SNAKE_CASE (`IMAGE_SIZE`, `BATCH_SIZE`)
...
- **[Testing Guide](testing.md)** - pytest, coverage
